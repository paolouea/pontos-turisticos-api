...
from core.api.viewsets import PontoTuristicosViewSet, DocIdentificacaoViewSet
...
router.register(r'pontosturisticos', PontoTuristicosViewSet, base_name=PontoTuristico)
